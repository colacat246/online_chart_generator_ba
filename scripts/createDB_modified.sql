...
-- -----------------------------------------------------
-- Table `online_charts_dev`.`line_graph_config`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `online_charts_dev`.`line_graph_config`;

CREATE TABLE IF NOT EXISTS `online_charts_dev`.`line_graph_config`
(
    `created_graph_id` INT(11)    NOT NULL,
    `title_show`       TINYINT(1) NOT NULL DEFAULT '1',
    PRIMARY KEY (`created_graph_id`),
    CONSTRAINT `line_graph_config_ibfk_1`
        FOREIGN KEY (`created_graph_id`)
            REFERENCES `online_charts_dev`.`user2graph_map` (`created_graph_id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
...
-- -----------------------------------------------------
-- Table `online_charts_dev`.`line_graph_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `online_charts_dev`.`line_graph_data`;

CREATE TABLE IF NOT EXISTS `online_charts_dev`.`line_graph_data`
(
    `created_graph_id` INT(11) NOT NULL,
    `line_id`          INT(11) NOT NULL COMMENT '第几条线',
